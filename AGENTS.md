...
- **Firestore collections**:
  ...
  - `spaces/{spaceId}` — `SpaceConfig` with activeCategories, creditsEnabled, videos
...
- **Space/multi-tenant**: Each admin manages users within their `spaceId`; space configuration propagates to all space users
...
- When you notice something that should be in AGENTS.md but isn't — propose the edit. Don't wait to be asked.
